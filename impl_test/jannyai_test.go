...
func TestJannyAIImport(t *testing.T) {
	t.Parallel()
	ca := FetchAndAssert(t, "https://jannyai.com/characters/421439ad-de63-4448-bc9b-c2c75cedb0af_character-amber-hawthorn").
		AssetJannyAICookie()
	testJannyAI(t, ca)
}

func TestJannyAIImportAutoFetch(t *testing.T) {
	t.Parallel()
	ca := FetchAndAssertWithRouter(t, afTestRouter, "https://jannyai.com/characters/421439ad-de63-4448-bc9b-c2c75cedb0af_character-amber-hawthorn")
	testJannyAI(t, ca)
}

func testJannyAI(t *testing.T, ca *CharacterAssertion) *CharacterAssertion {
	return ca.AssetJannyAIChromeConfig().
		AssertNoErr().
